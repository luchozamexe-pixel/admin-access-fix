...
CREATE TYPE public.order_status AS ENUM (
  ...
  'pedido_recibido','archivo_pendiente_revision','archivo_con_observaciones'
);
CREATE TYPE public.payment_status AS ENUM (
  'pendiente','pagado','fallido','reembolsado',
  'rechazado','manual_confirmado','mercado_pago_pendiente','mercado_pago_aprobado','mercado_pago_rechazado'
);
...
CREATE POLICY "Anyone can view orders by number" ON public.orders FOR SELECT USING (true);
